...
public class ResetPasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageTitle = findViewById(R.id.reset_password_text);
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()) {
                        ...
                        if (dataSnapshot.hasChild("Security questions")) {
                            ...
                            Toast.makeText(ResetPasswordActivity.this, "Please set the security questions!", Toast.LENGTH_SHORT).show();
    ...
    private void setAnswers() {
        ...
        if (question1.equals("") && question2.equals("")) {
            ...
            ref.child("Security questions").updateChildren(userdataMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()) {
                        Toast.makeText(ResetPasswordActivity.this, "The answers were correct!", Toast.LENGTH_SHORT).show();
