...
import com.example.myonlineshop.Admin.ApproveNewProductsActivity;
...
public class SellerHomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //for the recyclerview on the products list for the seller
                    ...
                    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                        switch (item.getItemId()) {
                            ...
                            case R.id.navigation_add:
                                Intent intentGate = new Intent(SellerHomeActivity.this, SellerProductCategoryActivity.class);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Products, ItemViewHolder> adapter = new FirebaseRecyclerAdapter<Products, ItemViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull ItemViewHolder holder, int position, @NonNull final Products model) {
                ...
                //get product name and description,price,product state
