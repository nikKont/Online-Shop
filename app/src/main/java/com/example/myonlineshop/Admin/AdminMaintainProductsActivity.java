...
public class AdminMaintainProductsActivity extends AppCompatActivity {
    ...
    //retrieve the data from the homeactivity , same with productdetails
...
//same with product details
    ...
    private void deleteProduct() {
        productsRef.removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                Toast.makeText(AdminMaintainProductsActivity.this, "You deleted the product successfully!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void applyChanges() {
        ...
        if (pName.equals("")) {
            ...
            //store this data in database if everything is ok
    ...
    private void displayProductInfo() {
        ...
        productsRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                //taken from the adminaddnewproduct activity
                if (dataSnapshot.exists()) {
                    String pName = dataSnapshot.child("name").getValue().toString();
                    String pPrice = dataSnapshot.child("price").getValue().toString();
                    String pDesscription = dataSnapshot.child("description").getValue().toString();
                    String pImage = dataSnapshot.child("image").getValue().toString();

                    name.setText(pName);
                    price.setText(pPrice);
                    description.setText(pDesscription);
